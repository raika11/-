...
export default ({ locale, makeSvgIcon }) => `
    <ul class="tui-image-editor-submenu-item">
        <li class="tie-crop-preset-button">
            ...
            <div class="tui-image-editor-button preset preset-1-1">
                <div>
        ...
        <li class="tui-image-editor-button image-size">
            <input type="number" class="image-width crop-width" value="0"/>
            <span>X</span>
            <input type="number" class="image-height crop-height" value="0"/>
        </li>

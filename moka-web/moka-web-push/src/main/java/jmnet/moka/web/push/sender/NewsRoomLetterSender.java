...
public class NewsRoomLetterSender extends AbstractPushSender {
    ...
    public NewsRoomLetterSender(PushAppService pushAppService, PushContentsService pushContentsService,
            PushContentsProcService pushContentsProcService, PushAppTokenService pushAppTokenService, PushAppTokenHistService pushAppTokenHistService,
    ...
    protected List<PushAppToken> findAllToken(String pushType, long contentSeq, int appSeq, long lastTokenSeq, int pageIdx, int tokenCnt)
        ...
        int totalPages = 100;//pushAppTokenlist.getTotalPages();

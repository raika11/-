// Type definitions for TOAST UI Image Editor v3.9.6
...
declare namespace tuiImageEditor {
    ...
    interface IThemeConfig {
        ...
        'applyButton.backgroundColor'?: string;
        'applyButton.border'?: string;
        'applyButton.color'?: string;
        'applyButton.fontFamily'?: string;
        'applyButton.fontSize'?: string;

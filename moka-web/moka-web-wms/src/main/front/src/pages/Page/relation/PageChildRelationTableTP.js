...
import {
    ...
    TemplateTableButton,
    // TemplateActionMenu,
    templateSearchColumns as searchColumns
} from '../components';
...
const PageChildRelationTableTP = () => {
                            ...
                            actionButtons={[
                                {
                                    key: 'add1',
                                    icon: 'add',
                                    onClick: (row, anchorRef) => {
                                        const tag = `${new Date().getTime()}<mte:tp id="${
                                            row.templateSeq
...
export default PageChildRelationTableTP;

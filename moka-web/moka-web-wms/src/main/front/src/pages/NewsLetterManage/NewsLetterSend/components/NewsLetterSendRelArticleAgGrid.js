...
import columnDefs from './NewsLetterSendRelArticleAgGridColumns';
...
/**
 * 뉴스레터 발송 관리 > 관련기사 테이블 AgGrid
 */
const RelArticleAgGrid = ({ chnlSeq, epsdSeq, articles, gridInstance, setGridInstance }) => {
...
export default RelArticleAgGrid;

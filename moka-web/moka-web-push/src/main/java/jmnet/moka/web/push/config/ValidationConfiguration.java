...
public class ValidationConfiguration implements BeanNameAware {
    ...
    private static final String VALIDATOR_BEAN = "pushValidator";
     ...
     */
    @Bean(VALIDATOR_BEAN)
    public LocalValidatorFactoryBean getValidator(@Autowired @Qualifier("pushMessageSource") MessageSource messageSource) {

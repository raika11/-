...
import columnDefs from './TemplateContainerAgGridColumns';
import { MokaTable } from '@components';
import { GET_RELATION_LIST, changeSearchCTOption, getRelationCTList, relationState } from '@store/template';

const TemplateContainerAgGrid = ({ show }) => {
    ...
    const [search, setSearch] = useState(relationState.CT);
...
export default TemplateContainerAgGrid;

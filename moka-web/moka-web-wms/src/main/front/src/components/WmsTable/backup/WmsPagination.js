...
import PaginationStyle from '~/assets/jss/components/Table/PaginationStyle';
import { PAGESIZE_OPTIONS, DISPLAY_PAGE_NUM } from '../../constants';

const useStyles = makeStyles(PaginationStyle);

const WmsPagination = ({ total, page, size, pageSizes, displayPageNum, onChangeSearchOption }) => {

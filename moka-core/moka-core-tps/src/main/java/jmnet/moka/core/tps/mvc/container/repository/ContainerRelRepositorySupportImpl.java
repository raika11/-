...
public class ContainerRelRepositorySupportImpl extends QuerydslRepositorySupport
        implements ContainerRelRepositorySupport {
    ...
    public List<ContainerRel> findList(String relType, Long relSeq) {
        ...
        JPQLQuery<ContainerRel> query = queryFactory
                .select(Projections.fields(ContainerRel.class, container.as("container"),
                        domain.as("domain"), containerRel.relType.as("relType"),

 ...
 * @property {string} applyButton.backgroundColor - apply button background color
 * @property {string} applyButton.border - apply button border style
 * @property {string} applyButton.color - apply button foreground color
 * @property {string} applyButton.fontFamily - apply button font type
 * @property {string} applyButton.fontSize - apply button font size
...
export default {
    ...
    'en-US.text.apply': 'Apply',
    'en-US.text.close': 'Close',
    'en-US.text.download': 'Download',

    'ko-KR.text.apply': '적용',
    'ko-KR.text.close': '취소',
    'ko-KR.text.download': '내려받기',
    ...
    'applyButton.border': '0',
    'applyButton.color': '#fff',
    'applyButton.fontFamily': "'Noto Sans', sans-serif",
    'applyButton.fontSize': '16px',

    // download button
    'downloadButton.backgroundColor': '#a8a8a8',

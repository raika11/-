 ...
 * action
 */
export const CLEAR_HISTORY = 'containerHistoryStore/CLEAN_HISTORY';
export const CHANGE_SEARCH_OPTION = 'containerHistoryStore/CHANGE_SEARCH_OPTION';
export const [
    GET_HISTORY_LIST,
    GET_HISTORY_LIST_SUCCESS,
    GET_HISTORY_LIST_FAILURE
] = createRequestActionTypes('containerHistoryStore/GET_HISTORY_LIST');
...
export const getHistoryListSaga = createListSaga(
    GET_HISTORY_LIST,
    containerAPI.getHistoryList,
    CHANGE_SEARCH_OPTION,
    (state) => state.containerHistoryStore
);

export function* containerHistorySaga() {
 ...
 * reducer
 */
const containerHistoryStore = handleActions(
    {
        // clear
...
export default containerHistoryStore;

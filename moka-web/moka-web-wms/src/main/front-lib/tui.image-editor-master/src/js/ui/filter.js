...
class Filter extends Submenu {
    ...
    addEvent({ applyFilter }) {
        ...
        this._els.blurRange.on('change', changeFilterStateForRange('blur'));
    ...
    _setFilterState(filterName, options) {
        ...
        if (filterName === 'colorFilter') {
            ...
            this._els.blurRange.value = options.blur;
    ...
    _getFilterOption(type) {
        ...
        switch (type) {
            ...
            case 'pixelate':
                ...
                break;
            case 'blur':
                option.blur = parseFloat(this._els.blurRange.value);
                break;
            case 'noise':
    ...
    _makeControlElement() {
        this._els = {
            ...
            blurRange: new Range({ slider: this.selector('.tie-blur-range') }, FILTER_RANGE.blurRange),

...
import { columnDefs } from './NewsLetterSendArticleAgGridColumns';
...
/**
 * 뉴스레터 관리 > 뉴스레터 발송 관리 > 기사 검색 매핑 AgGrid
 */
const NewsLetterSendArticleAgGrid = () => {
...
export default NewsLetterSendArticleAgGrid;

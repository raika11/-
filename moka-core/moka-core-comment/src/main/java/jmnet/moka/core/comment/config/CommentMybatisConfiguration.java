/**
 * msp-tps-comment WebMvcConfiguration.java 2019. 11. 29. 오후 2:05:07 ssc
 */
...
@MapperScan(basePackages = "jmnet.moka.core.comment.mvc.**.mapper", sqlSessionFactoryRef = "commentSqlSessionFactory")
...
public class CommentMybatisConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = "comment.mybatis")
    public MybatisProperties commentMybatisProperties() {
    ...
    public CommentMybatisConfiguration(ObjectProvider<Interceptor[]> interceptorsProvider,
    ...
    @Bean
    public SqlSessionFactory commentSqlSessionFactory(@Autowired @Qualifier("commentMybatisProperties") MybatisProperties properties)
            throws Exception {
    ...
    @Bean
    public SqlSessionTemplate commentSqlSessionTemplate(@Autowired @Qualifier("commentSqlSessionFactory") SqlSessionFactory sqlSessionFactory,
            @Autowired @Qualifier("commentMybatisProperties") MybatisProperties properties) {
    ...
    @Bean
    public PlatformTransactionManager commentMybatisTransactionManager() {

 ...
 * action
 */
export const CLEAR_RELATION_SKIN = 'containerRelationCSStore/CLEAR_RELATION_SKIN';
export const CHANGE_SEARCH_OPTION = ' containerRelationCSStore/CHANGE_SEARCH_OPTION';
export const [
    GET_RELATION_SKIN_LIST,
    GET_RELATION_SKIN_LIST_SUCCESS,
    GET_RELATION_SKIN_LIST_FAILURE
] = createRequestActionTypes('containerRelationCSStore/GET_RELATION_SKIN_LIST');
...
const getRelationSkinListSaga = createListSaga(
    ...
    (state) => state.containerRelationCSStore
);

export function* containerRelationCSSaga() {
 ...
 * reducer
 */
const containerRelationCSStore = handleActions(
    {
        // clear
...
export default containerRelationCSStore;

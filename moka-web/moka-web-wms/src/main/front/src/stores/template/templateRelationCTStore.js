 ...
 * action
 */
export const CHANGE_SEARCH_OPTION = 'templateRelationCTStore/CHANGE_SEARCH_OPTION';
export const CHANGE_SEARCH_OPTIONS = 'templateRelationCTStore/CHANGE_SEARCH_OPTIONS';
export const [
    GET_RELATIONS,
    GET_RELATIONS_SUCCESS,
    GET_RELATIONS_FAILURE
] = createRequestActionTypes('templateRelationCTStore/GET_RELATIONS');
export const CLEAR_RELATIONS = 'templateRelationCTStore/CLEAR_RELATIONS';
 ...
 * reducer
 */
const templateRelationCTStore = handleActions(
    {
...
export default templateRelationCTStore;

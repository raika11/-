...
public class PreviewConfiguration {
    ...
    public HttpProxyDataLoader httpProxyDataLoader(String apiHost, String apiPath) {
        HttpProxy httpProxy = (HttpProxy) appContext.getBean(HttpProxyConfiguration.API_HTTP_PROXY,
                apiHost, apiPath);
    ...
    @Bean
    @Scope("prototype")
    public AbstractTemplateLoader workTemplateLoader(String domainId, String workerId,

...
import columnDefs from './NewsLetterMethodResultAgGridColumns';

/**
 * 뉴스레터 관리 > 뉴스레터 발송 결과 관리 > 발송 방법별 AgGrid
 */
const NewsLetterMethodResultAgGrid = ({ match, setDisplay }) => {
...
export default NewsLetterMethodResultAgGrid;

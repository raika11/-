...
public class JpodEpisodeController extends AbstractCommonController {
    ...
    public JpodEpisodeController(JpodEpisodeService jpodEpisodeService, FtpHelper ftpHelper) {

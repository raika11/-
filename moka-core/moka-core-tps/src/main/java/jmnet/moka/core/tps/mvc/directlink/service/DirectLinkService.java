...
/**
 * 사이트이동 서비스 2020. 1. 8. ssc 최초생성 메소드 생성 규칙 목록 조회 : findAllDirectLink{Target}List ID로 상세 조회 : find{Target}ById 여러 속성으로 상세 조회 : find{Target} 등록 :
 * insertDirectLink{Target} 수정 : updateDirectLink{Target} 삭제 :  deleteDirectLink{Target} 중복조회 : isDuplicatedId{Target} 이미지저장 : saveImage{Target} 이미지삭제
 * : deleteImage{Target} 멤버목록조회 : hasMembers{Target}
 *
 * @author ssc
...
public interface DirectLinkService {
     ...
     */
    String saveImage(DirectLink directLink, MultipartFile thumbnail)
            throws Exception;
     ...
     * @throws Exception 예외처리
     */
    boolean deleteImage(DirectLink directLink)
            throws Exception;

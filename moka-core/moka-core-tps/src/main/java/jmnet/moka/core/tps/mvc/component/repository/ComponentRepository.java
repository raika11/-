...
@Repository
public interface ComponentRepository extends JpaRepository<Component, Long>, ComponentRepositorySupport {
     ...
     */
    @EntityGraph(attributePaths = {"dataset"}, type = EntityGraph.EntityGraphType.LOAD)
    public Optional<Component> findByDataTypeAndDataset_DatasetSeq(String dataType, Long datasetSeq);

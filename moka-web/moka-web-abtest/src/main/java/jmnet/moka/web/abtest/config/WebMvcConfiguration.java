...
public class WebMvcConfiguration extends WebMvcAutoConfiguration implements WebMvcConfigurer {
     ...
     */
    @Bean
    public LocaleResolver abtestLocaleResolver() {
     ...
     */
    @Bean
    public MessageByLocale messageByLocale(@Autowired @Qualifier("abtestMessageSource") MessageSource messageSource,
            @Autowired @Qualifier("abtestLocaleResolver") LocaleResolver localeResolver) {

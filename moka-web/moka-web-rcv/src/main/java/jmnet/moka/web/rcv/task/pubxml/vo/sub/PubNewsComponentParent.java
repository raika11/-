...
public class PubNewsComponentParent implements Serializable {
    ...
    private PubNewsAdministrativeMetadata administrativeMetadata;

    @XmlElement(name = "DescriptiveMetadata")
    private String descriptiveMetadata;

    @XmlElement(name = "NewsComponent")
    private List<PubNewsComponent> components;
}

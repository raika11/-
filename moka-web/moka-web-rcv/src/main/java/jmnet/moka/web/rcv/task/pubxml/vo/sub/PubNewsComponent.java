...
public class PubNewsComponent implements Serializable {
    private static final long serialVersionUID = 4509593451780542785L;

    @XmlElement(name = "NewsLines")
    private PubNewsLines newsLines;

    @XmlElement(name = "DescriptiveMetadata")
    private PubDescriptiveMetadata descriptiveMetadata;

    @XmlElement(name = "ContentItem")
    private PubContentItem contentItem;
}

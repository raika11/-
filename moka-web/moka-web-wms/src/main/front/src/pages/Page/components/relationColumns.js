...
import PageLaunchButton from './PageLaunchButton';

/**
 * 관련페이지 검색조건
 */
export const pageSearchTypes = [
...
export const pageSearchColumns = [
    ...
    },
    {
        ...
        width: 30,
        align: 'center',
        component: (row) => <PageLaunchButton row={row} bHistory={false} />
    },
    {
        id: 'preview',
        format: 'component',
...
export const containerSearchColumns = [
    ...
    },
    {
        ...
        width: 30,
        align: 'center',
        component: (row) => <AppendTagButton itemType="ct" row={row} />
    },
    {
        id: 'detailPop',
        format: 'component',
...
export const historyColumns = [
    ...
    },
    {
        ...
        width: 70,
        align: 'center',
        component: (row) => <PageLaunchButton row={row} />
    }
];

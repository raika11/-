 ...
 * action
 */
export const CLEAR_RELATION_PAGE = 'datasetRelationPGStore/CLEAR_RELATION_PAGE';
export const CHANGE_SEARCH_OPTION = ' datasetRelationPGStore/CHANGE_SEARCH_OPTION';
export const [
    GET_RELATION_PAGE_LIST,
    GET_RELATION_PAGE_LIST_SUCCESS,
    GET_RELATION_PAGE_LIST_FAILURE
] = createRequestActionTypes('datasetRelationPGStore/GET_RELATION_PAGE_LIST');
...
const getRelationPageListSaga = createListSaga(
    ...
    (state) => state.datasetRelationPGStore
);

export function* datasetRelationPGSaga() {
 ...
 * reducer
 */
const datasetRelationPGStore = handleActions(
    {
        // clear
...
export default datasetRelationPGStore;

...
import { lgTableColums, mdTableColumns } from './dialogColumns';
import {
    getLargeCodes,
    getMiddleCodes,
    changeSearchOption,
 ...
 */
const LMCodesDialog = (props) => {
    const { open, onClose, searchCodeId, setSearchCodeId } = props;
    const dispatch = useDispatch();
    const classes = useStyle();
    const { largeCodes, middleCodes, lLoading, mLoading } = useSelector((state) => ({

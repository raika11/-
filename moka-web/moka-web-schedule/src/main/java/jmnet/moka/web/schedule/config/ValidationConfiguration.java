...
public class ValidationConfiguration implements BeanNameAware {
    ...
    private static final String VALIDATOR_BEAN = "scheduleValidator";
     ...
     */
    @Bean
    public MessageSource scheduleMessageSource() {
     ...
     */
    @Bean(VALIDATOR_BEAN)
    public LocalValidatorFactoryBean getValidator(@Autowired @Qualifier("scheduleMessageSource") MessageSource messageSource) {

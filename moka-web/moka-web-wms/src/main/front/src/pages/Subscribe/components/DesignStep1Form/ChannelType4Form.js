 ...
 * 채널타입 4 폼
 */
const ChannelType4Form = ({ scb, onChangeValue }) => {
    const [selected, setSelected] = useState(null);

    return (
        <React.Fragment>
            <p className="mb-2">중앙일보에서 발행되는 뉴스레터를 대상으로 합니다.</p>
            <div className="flex-fill input-border px-12 py-2 mb-12 custom-scroll">
                <div className="d-flex justify-content-between align-items-center w-100 mb-2">
                    <span>뉴스레터 대상 선택</span>
...
ChannelType4Form.defaultProps = defaultProps;

export default ChannelType4Form;

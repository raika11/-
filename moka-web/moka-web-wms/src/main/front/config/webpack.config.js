...
const nt = new Date();
const buildDatetime = `${nt.getFullYear()}${pad(nt.getMonth()+1)}${pad(nt.getDate())}${pad(nt.getHours())}${pad(nt.getMinutes())}`;
...
module.exports = function (webpackEnv) {
    ...
    const envConfig = require('./webpack.' + webpackEnv + '.config.js')(webpackEnv);
    ...
    return {
        ...
        output: {
            ...
            chunkFilename: `static/js/bundle.[name].[contenthash:8].chunk.js`,

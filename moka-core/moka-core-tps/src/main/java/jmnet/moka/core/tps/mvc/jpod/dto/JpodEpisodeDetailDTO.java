...
public class JpodEpisodeDetailDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final Type TYPE = new TypeReference<List<JpodEpisodeDetailDTO>>() {
    }.getType();
     ...
     * 에피소드 등록일
     */
    @ApiModelProperty("에피소드 등록일 (형식 : yyyy-MM-dd)")
    ...
    @NotEmpty(message = "{tps.jpod-episode.error.notempty.epsdNm}")
    ...
    @NotEmpty(message = "{tps.jpod-episode.error.notempty.epsdMemo}")
    @Size(max = 4000, message = "{tps.jpod-episode.error.size.epsdMemo}")
    ...
    @ApiModelProperty("관련 기사 목록")
    private List<JpodEpisodeRelArtDTO> articles;

 ...
 * action
 */
export const CHANGE_SEARCH_OPTION = 'templateRelationCPStore/CHANGE_SEARCH_OPTION';
export const CHANGE_SEARCH_OPTIONS = 'templateRelationCPStore/CHANGE_SEARCH_OPTIONS';
export const [
    GET_RELATIONS,
    GET_RELATIONS_SUCCESS,
    GET_RELATIONS_FAILURE
] = createRequestActionTypes('templateRelationCPStore/GET_RELATIONS');
export const CLEAR_RELATIONS = 'templateRelationCPStore/CLEAR_RELATIONS';
 ...
 * reducer
 */
const templateRelationCPStore = handleActions(
    {
...
export default templateRelationCPStore;

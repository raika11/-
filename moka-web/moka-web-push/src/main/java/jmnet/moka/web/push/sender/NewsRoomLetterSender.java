...
public class NewsRoomLetterSender extends AbstractPushSender {
    ...
    public NewsRoomLetterSender(PushAppService pushAppService, PushContentsService pushContentsService, PushContentsProcService pushContentsProcService, PushAppTokenService pushAppTokenService, PushAppTokenHistService pushAppTokenHistService, PushTokenSendHistService pushTokenSendHistService) {
    ...
    protected PushResponseMessage sendMessage(List<PushAppToken> pushTokens, FcmMessage pushMessage) throws Exception {
        ...
        log.info("[ NewsRoomLetterSender PushResponseMessage sendMessage ]");
    ...
    //protected PushHttpResponse pushSend(List<PushAppToken> pushToken, PushApp pushApp, FcmMessage fcmMessage)
            throws Exception {
        log.info("[ NewsRoomLetterSender pushSend ] "+token);

...
export const MOSAIC_DEFAULT_OPTIONS = {
...
export const commandNames = {
    ...
    ADD_SHAPE: 'addShape',
    ADD_MOSAIC: 'addMosaic',
    CHANGE_SHAPE: 'changeShape',
    CHANGE_MOSAIC: 'changeMosaic',
    ADD_TEXT: 'addText',
    ...
    CHANGE_WATERMARK_OPACITY: 'changeWatermarkOpacity',
};
...
export const defaultResizeRangeValus = {
    realTimeEvent: true,
    min: 1,
    max: 300,
    value: 1,
...
export const defaultMosaicValus = {
    realTimeEvent: true,
    min: 1,
    max: 50,
    value: 10,
...
export const defaultOpacityValus = {
    realTimeEvent: true,
    min: 0,
    max: 10,
    value: 10,

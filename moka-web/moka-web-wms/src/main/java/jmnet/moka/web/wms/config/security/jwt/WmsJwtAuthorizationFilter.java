...
public class WmsJwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (auth != null && auth instanceof UsernamePasswordAuthenticationToken) {
            ...
            if (header != null && expiredOrDuplicated(request, response, auth,
        ...
        Authentication jwtAuth =
                WmsJwtHelper.getUsernamePasswordAuthentication(request, userService);
    ...
    private boolean expiredOrDuplicated(HttpServletRequest request, HttpServletResponse response,
            Authentication auth, String sessionId) throws IOException {
        List<SessionInformation> siList =
                this.sessionRegistry.getAllSessions(auth.getPrincipal(), false);

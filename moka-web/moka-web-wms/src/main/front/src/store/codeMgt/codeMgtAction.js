...
export const GET_AT = 'codeMgt/GET_AT';
export const GET_SVC_AT = 'codeMgt/GET_SVC_AT';
...
export const GET_LETTER_CATE = 'codeMgt/GET_LETTER_CATE';
...
export const getAt = createAction(GET_AT);
export const getSvcAt = createAction(GET_SVC_AT);
...
export const getLetterCate = createAction(GET_LETTER_CATE);

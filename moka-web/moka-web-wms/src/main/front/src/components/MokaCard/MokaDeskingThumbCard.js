 ...
 */
const MokaDeskingThumbCard = forwardRef((props, ref) => {
    const { onClick, width, height, data, img, alt, selected } = props;
...
MokaDeskingThumbCard.propTypes = propTypes;
MokaDeskingThumbCard.defaultProps = defaultProps;

export default MokaDeskingThumbCard;

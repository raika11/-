 ...
 */
const ArticleListView = ({ classes, open, setOpen, article }) => {
    ...
    const handleCloseBtn = (e) => {
        ...
        if (articleRef.current) {
            articleRef.current.classList.add(classes.articleListViewHide);
    ...
    return (
        <div
            className={clsx(classes.articleListView, {
                [classes.articleListViewShow]: open
            })}
            ref={articleRef}
        >
            <div

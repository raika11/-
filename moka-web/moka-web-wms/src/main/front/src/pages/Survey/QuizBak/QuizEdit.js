            ...
            <Form>
                <Form.Row className="mb-2 p-2">
                    <Col xs={9}>
                        ...
                        <Form.Row className="mb-2">
                            <Col xs={12}>
                                <MokaInputLabel label="퀴즈 제목" labelWidth={66} required={true} value={editData.title} onChange={(e) => handleChangeEditData(e)} />
                            </Col>
                        </Form.Row>
                        <Form.Row className="mb-2">
                            <Col xs={12}>
                ...
                <Form.Row className="mb-2 p-2 bg-gray150">
                    <Form.Row className="w-100 justify-content-between">
                        <Col xs={7}>
                            <Form.Row>
                                <Col xs={6}>
                                    <MokaInputLabel as="select" labelWidth={66} label="문항 유형" onChange={(e) => handleChangeEditData(e)}>
                                        <option value="1">객관식</option>
                                        <option value="2">주관식</option>
                                    </MokaInputLabel>
                                </Col>
                                <Col xs={6}>
                                    <MokaInputLabel type="number" label="보기 입력 개수" labelWidth={85} value={100} onChange={(e) => handleChangeEditData(e)} />
                                </Col>
                            </Form.Row>
                        </Col>
                        <Col xs={3}>
                            <Form.Row>
                                ...
                                <Col xs={8} className="ml-2">
                                    <Button variant="searching">문항 검색</Button>
                                </Col>
                            </Form.Row>
                        </Col>
                    </Form.Row>

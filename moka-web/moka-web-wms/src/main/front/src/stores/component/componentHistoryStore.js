 ...
 * action
 */
export const CHANGE_SEARCH_OPTION = 'componentHistoryStore/CHANGE_SEARCH_OPTION';
export const CLEAR_HISTORIES = 'componentHistoryStore/CLEAR_HISTORIES';
export const [
    GET_HISTORIES,
    GET_HISTORIES_SUCCESS,
    GET_HISTORIES_FAILURE
] = createRequestActionTypes('componentHistoryStore/GET_HISTORIES');
 ...
 * reducer
 */
const componentHistoryStore = handleActions(
    {
...
export default componentHistoryStore;
